/*
 * javadata_dog3d_2nd.java		v0.04, February 28, 1998
 * (July 25th, 1998; September 11th, 1998)
 * 
 ...
 */
class javadata_dog3dBSPNode_2nd{	
	public float[] partition = null; 
	public Object[] lines = null;
	public javadata_dog3dBSPNode_2nd front = null;
	public javadata_dog3dBSPNode_2nd back = null;
}
 ...
 * (02/28/1998)
 */
class javadata_dog3dBSPTree_2nd{

	/**
	 * the root of the tree...
	 */
	private javadata_dog3dBSPNode_2nd root;
	 ...
	 */
	private javadata_dog3d_2nd theParent = null;
	 ...
	 */
	public javadata_dog3dBSPTree_2nd(javadata_dog3d_2nd p){
		root = null;
		eye_x = eye_y = 0;
		eye_angle = 0.0;
		theParent = p;
	 ...
	 */
	private void build(javadata_dog3dBSPNode_2nd tree,Vector lines){
		...
		if(!front_list.isEmpty()){
			tree.front = new javadata_dog3dBSPNode_2nd();
			build(tree.front,front_list);
		}if(!back_list.isEmpty()){
			tree.back = new javadata_dog3dBSPNode_2nd();
	...
	public void build(Vector lines){
		if(root == null)
			root = new javadata_dog3dBSPNode_2nd();
		build(root,lines);
	}
	 ...
	 */
	private void renderTree(javadata_dog3dBSPNode_2nd tree){
		int[] tmp = null;
		if(tree == null)
 ...
 * (02/28/1998)
 */
public class javadata_dog3d_2nd extends Applet implements Runnable{
	/**
	 * variables...
	 */
	...
	private javadata_dog3dBSPTree_2nd theTree = null;
	...
	public void init(){
		...
		theTree = new javadata_dog3dBSPTree_2nd(this);
